...
BOL_CONF = create_currency_config("ZEC", "Zcash", sub_coin_config=None)
# Serialized derivation path for the Boilerplate app
BOL_PACKED_DERIVATION_PATH = pack_derivation_path(ZEC_PATH)
# Coin configuration mock as stored in CAL for the SWAP feature
BOL_CURRENCY_CONFIGURATION = CurrencyConfiguration(ticker="ZEC", conf=BOL_CONF, packed_derivation_path=BOL_PACKED_DERIVATION_PATH)
...
BOL_DYNAMIC_USDT_CURRENCY_CONFIGURATION = CurrencyConfiguration(ticker="USDT", conf=BOL_DYNAMIC_USDT_CONF, packed_derivation_path=BOL_DYNAMIC_USDT_PACKED_DERIVATION_PATH)
